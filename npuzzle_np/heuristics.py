...
def misplaced_tiles_heuristic(board: np.ndarray, goal_board: np.ndarray) -> int:
    misplaced = np.sum(board != goal_board) - 1
    return misplaced

def linear_conflict_heuristic(board: np.ndarray, goal_board: np.ndarray) -> int:
